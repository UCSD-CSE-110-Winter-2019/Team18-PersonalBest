...
public class LoginUITest {
    ...
    public void loginUITest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.heightft_input),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.heightin_input),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.edit_goal_btn), withText("edit"),
                        childAtPosition(
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.goal_edit), withText("5000"),
                        childAtPosition(
                                allOf(withId(R.id.container),
                                        childAtPosition(
                                                withClassName(is("android.widget.RelativeLayout")),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.goal_edit), withText("5000"),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("0"));

        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.goal_edit), withText("0"),
                        childAtPosition(
                                allOf(withId(R.id.container),
                                        childAtPosition(
                                                withClassName(is("android.widget.RelativeLayout")),
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.edit_goal_btn), withText("save"),
                        childAtPosition(
                                allOf(withId(R.id.container),
                                        childAtPosition(
                                                withClassName(is("android.widget.RelativeLayout")),
        ...
        ViewInteraction appCompatButton4 = onView(
                allOf(withId(R.id.back_home_btn), withText("Next Time"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.current_goal), withText("0"),
                        childAtPosition(
                                allOf(withId(R.id.container),
                                        childAtPosition(
